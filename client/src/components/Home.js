...
const Home = () => (
  <Segment basic>
    ...
    <Header as='h1'>(801) 266-4420</Header>
    <Grid>
      <Grid.Column computer={8} tablet={12} mobile={12}>
        <Grid.Row>
          <Header as='h1' textAlign='center'>Over 30 Yrs Experience</Header>
          <Header as='h1' textAlign='center'>Solid, Dependable Service</Header>
          <Header as='h1' textAlign='center'>Licensed & Insured</Header>
          <Header as='h1' textAlign='center'>4645 S 500 W</Header>
          <Header as='h1' textAlign='center'>Murray UT, 84123</Header>
        </Grid.Row>
      </Grid.Column>
      <Grid.Column computer={8} tablet={12} mobile={12}>
        <Grid.Row>
